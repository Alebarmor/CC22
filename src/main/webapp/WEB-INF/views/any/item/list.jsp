...
<acme:list>
    ...
    <acme:list-column code="any.item.list.label.retailPrice" path="retailPrice" width="15%"/>
    <acme:list-column code="any.item.list.label.inventor" path="fullname" width="15%"/>
</acme:list>