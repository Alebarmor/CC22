...
<acme:form>
	<jstl:choose>
		<jstl:when test="${command == 'create'}">
			...
			<acme:input-select code="patron.xx1.form.label.item" path="items">
		...
		<jstl:when test="${acme:anyOf(command, 'show, update, delete')}">
			<acme:input-textbox code="patron.xx1.form.label.code" path="code" readonly="true"/>
			<acme:input-textbox code="patron.xx1.form.label.item" path="item" readonly="true"/>
    ...
    <acme:input-url code="patron.xx1.form.label.xx7" path="xx7"/>
    	...
    	<jstl:choose>
			...
			<jstl:when test="${command == 'create'}">
				<acme:submit code="patron.xx1.form.button.create" action="/patron/xx1/create"/>
			</jstl:when>
		</jstl:choose>
